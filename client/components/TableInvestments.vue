<template>
  <v-card flat title="Investimentos">
    ...
    <v-data-table :headers="headers" :items="investments" :search="search" density="compact">
...
const investments = ref<Transaction[]>(store.investments);
